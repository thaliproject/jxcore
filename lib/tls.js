...
CryptoStream.prototype.destroy = function(err) {
  ...
  process.nextTick(function() {
    ...
    // Emit 'close' event
    self.emit('close', err ? true : false, err, true); // eventName, hadError, error, destroyNow
  });
};
...
exports.createSecurePair = function(credentials,
  ...
  var pair = new SecurePair(credentials,
                            ...
                            requestCert,
                            rejectUnauthorized,
                            pskCallback ? { pskClientCallback: pskCallback  } : null);
  return pair;
};
...
function pipe(pair, socket) {
  ...
  pair.encrypted.on('close', function(hadError, error, destroyNow) {
    process.nextTick(function() {
